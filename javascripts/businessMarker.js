// Business Marker
function addBusinessMarker(map, details) {
    // Icon Defaults
    let defaultImgs = [
        '/images/bioalpha.png'
    ];
    ...
    google.maps.event.addListener(marker, 'click', function(e) {
        ...
        showBusinessModal(details,image);
    });
...
BusinessMarker.prototype = new google.maps.OverlayView();

function BusinessMarker(opts, img) {
    this.imgUrl = img;
    this.setValues(opts);
}

BusinessMarker.prototype.getPosition = function() {
    return this.position;
}

BusinessMarker.prototype.draw = function() {
    var self = this;
    var div = this.div;
    if (!div) {
        div = this.div = $('' +
...
BusinessMarker.prototype.animateDrop = function() {
...
BusinessMarker.prototype.animateBounce = function() {
    dynamics.stop(this.pinWrap);
    dynamics.css(this.pinWrap, {
        'transform': 'none',
    });
...
BusinessMarker.prototype.animateWobble = function() {
    dynamics.stop(this.pinWrap);
    dynamics.css(this.pinWrap, {
        'transform': 'none',
    });
